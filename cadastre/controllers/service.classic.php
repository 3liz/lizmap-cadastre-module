...
class serviceCtrl extends jController {
    ...
    private function getParcelleProfile($repository, $project, $parcelleLayer) {

        $profile = 'cadastre';
        $p = lizmap::getProject($repository.'~'.$project);
        $layer = $p->findLayerByName($parcelleLayer);
        if($layer){
            $parcelleId = $layer->id;
            $qgisLayer = $p->getLayer($parcelleId);
            if ($qgisLayer) {
    ...
    */
    function autocomplete() {
        ...
        $profile = $this->getParcelleProfile($repository, $project, $parcelleLayer);
